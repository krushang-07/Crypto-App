...
// const Home = () => {
//   return (
//     <Box bgColor={"white"} w={"full"} minH={"100vh"} py={10} color={"white"}>
//       <motion.div
//         style={{
//           height: "80vh",
//         }}
...
//         >
//           <HStack spacing={8}>
//             <Image src={exchange} boxSize="500px" borderRadius="md" />
//             <Box textAlign={"left"}>
//               <Heading fontSize={"2xl"} mb={4} color={"yellow.700"}>
...
//                 These platforms offer a wide range of services including
//                 spot trading, futures trading, staking, and more. Ensure to
//                 check their security features and user reviews before
//                 choosing a platform.
//               </Text>
//             </Box>
//           </HStack>
...
//         >
//           <HStack spacing={8}>
//             <Image src={coins} boxSize="500px" borderRadius="md" />
//             <Box textAlign={"left"}>
//               <Heading fontSize={"2xl"} mb={4} color={"yellow.700"}>
...
//                 performance to make informed investment decisions. Popular
//                 coins include Bitcoin, Ethereum, and Ripple.
//               </Text>
//               <Text fontSize={"md"} color={"yellow.800"}>
//                 Each cryptocurrency operates on different technologies and
//                 serves various purposes. Bitcoin is known for its store of value,
//                 Ethereum for its smart contracts, and Ripple for its cross-border
//                 payment solutions.
//               </Text>
//             </Box>
//           </HStack>
...
//         >
//           <HStack spacing={8}>
//             <Image src={nft} boxSize="500px" borderRadius="md" />
//             <Box textAlign={"left"}>
//               <Heading fontSize={"2xl"} mb={4} color={"yellow.700"}>
//                 Different NFTs
//               </Heading>
  ...
  return (
    <Box bgColor={"white"} w={"full"} minH={"100vh"} py={10} color={"black"}>
      ...
      <VStack spacing={12} mt={10} px={4}>
        ...
        >
          <HStack spacing={8}>
            <Image src={exchange} boxSize="400px" borderRadius="md" />
            <Box textAlign={"left"}>
              <Heading fontSize={"2xl"} mb={4} color={"yellow.700"}>
                Coin Exchange Platforms
              </Heading>
        ...
        >
          <HStack spacing={8}>
            <Image src={coins} boxSize="400px" borderRadius="md" />
            <Box textAlign={"left"}>
              <Heading fontSize={"2xl"} mb={4} color={"yellow.700"}>
                Different Crypto Coins
              </Heading>
        ...
        >
          <HStack spacing={8}>
            <Image src={nft} boxSize="400px" borderRadius="md" />
            <Box textAlign={"left"}>
              <Heading fontSize={"2xl"} mb={4} color={"yellow.700"}>
                Different NFTs
              </Heading>
